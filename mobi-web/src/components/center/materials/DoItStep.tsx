//mobi-web/src/components/center/materials/DoItStep.tsx
...
function DoItStep({ stepKey, onChange }: DoItStepProps) {
  ...
  const handleMaterialKeyDown = (
    ...
    updateParent(instruction, nextMaterials);
    setMaterialInput("");
  };
  ...
  return (
    <>
          ...
          <div className="mb-4">
            ...
            <div className="bg-white border border-gray-300 h-64 flex items-center justify-center">
              ...
              <input
                ...
                onChange={handleMediaUpload}
                className="hidden"
                id={`do-it-media-upload-${stepKey}`}
              />

              <label
                htmlFor={`do-it-media-upload-${stepKey}`}
                className="cursor-pointer"
              >
                {selectedFile ? (
                  <div className="relative flex items-center justify-center h-full">
      ...
      <VoiceStyleModal
        ...
        onSelectStyle={(style) => {
          setVoiceStyle(style);
          updateParent(instruction, materials, style);
        }}
        stepType="teach"
      />
    </>
